										...
										success : function(data) {
											...
											for (var i = 0; i < data.list.length; i++) {
												...
												resultText += "<td class=th2>"
														...
														+ "</td>";
												resultText += "<td class=th2>"
												+ "<button class='btn btn-danger' data-rentApply="+data.list[i].rentApply+" onclick='agreeRentApply(this)' style='border:none; background-color:#00a3e0;'>승인</button>"
												+ "</td></tr>";
											}
...
<!--             <div class="topbar-divider d-none d-sm-block"></div> -->
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="/member/logout.do" data-toggle="modal" data-target="#logoutModal">
													...
													<tbody id="tbody">
														<c:forEach items="${list }" var="l" varStatus="i">
															<tr>
																...
																<td class="th2">
																	<button class="btn btn-danger" data-rentApply="${l.rentApply }" onclick="agreeRentApply(this)" style="border:none; background-color:#00a3e0;">승인</button>
																</td>
															</tr>
														</c:forEach>
													</tbody>
